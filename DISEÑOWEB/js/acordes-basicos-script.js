document.addEventListener('DOMContentLoaded', function() {
    ...
    const acordesData = {
        ...
        'D': {
            nombre: 'Re Mayor',
            descripcion: 'Para formar el acorde D, coloca los dedos en el segundo traste de la cuerda 1, el tercer traste de la cuerda 2 y el segundo traste de la cuerda 3.',
            audioSrc: '/audio/d-major.mp3',
            tips: 'Mantén los dedos arqueados para evitar tocar otras cuerdas.'
        },
        'G': {
            nombre: 'Sol Mayor',
            descripcion: 'El acorde G se forma colocando los dedos en el tercer traste de la cuerda 1, el segundo traste de la cuerda 5 y el tercer traste de la cuerda 6.',
    ...
    acordeItems.forEach(item => {
        item.addEventListener('click', function() {
            ...
            acordeAudio.innerHTML = `
                <audio controls>
                    <source src="${acordeData.audioSrc}" type="audio/mpeg">
